...
export default function App() {
  const { users, loading: apiLoading, addUser, refreshAll } = useLeetCode();
  ...
  // Prevent UI flash while checking if the user is authenticated
  if (authLoading) {
    return (
  ...
  // --- LANDING PAGE: Show this if logged out ---
  if (!user) {
    return (
  ...
  // --- MAIN APP: Show this if logged in ---
  return (
